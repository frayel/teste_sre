...
FINANCE_PAYMENT_ENDPOINT = os.environ.get('FINANCE_PAYMENT_ENDPOINT', "http://localhost:8001/app/finance/record/")
KAFKA_URI = os.environ.get('KAFKA_URI', "localhost:9092")
KAFKA_TOPIC = os.environ.get('KAFKA_TOPIC', "pending_payment")
KAFKA_GROUP = os.environ.get('KAFKA_GROUP', "local_processor_1")
